    ...
    return (
        <section className='bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-70 z-50'>
            <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
                            ...
                            <>
                                ...
                                <div className='bg-white p-4'>
                                    ...
                                    <div className=''>
                                        ...
                                        <span style={{ fontSize: " 10px", fontSize: "12px", lineHeight: "15px", color: "rgb(130, 130, 130)", paddingBottom: "12px" }}>Orders cannot be cancelled once packed for delivery. In case of unexpected delays, a refund will be provided, if applicable.</span>
                                        {/* <p className='flex items-center gap-2'><span className='line-through text-neutral-400'>{DisplayPriceInRupees(notDiscountTotalPrice)}</span><span>{DisplayPriceInRupees(totalPrice)}</span></p> */}
                                    </div>
                ...
                {
                    cartItem[0] && (
                        <div className='p-2' onClick={redirectToCheckoutPage}>
