  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
        ...
        <div >
            ...
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh" }} className='image-zoom-container bg-white lg:min-h-[65vh] lg:max-h-[65vh] rounded min-h-56 max-h-56 h-full w-full'>
            <ImageZoom
               
                
                    src={data.image[image]}
                    className='w-full h-full object-scale-down image-zoom'
                /> 
            </div>
...
<hr />
            <div className='my-4  hidden lg:grid gap-3 ' style={{padding:"22px 6px 5px 12px",
